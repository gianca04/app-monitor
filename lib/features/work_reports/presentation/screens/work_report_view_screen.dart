              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Html(
                      data:
                          (state.report!.resources?.materials?.isEmpty ?? true)
                          ? 'None'
                    ...
                    Text(
                      'Created At: ${state.report!.timestamps?.createdAt ?? 'N/A'}',
                    ),
                    Text(
                      'Updated At: ${state.report!.timestamps?.updatedAt ?? 'N/A'}',
                    ),
                    const SizedBox(height: 16),
                    const Text(
                      'Employee:',
                    ...
                    Text(
                      'Position: ${state.report!.employee?.position?.name ?? 'N/A'}',
                    ),
                    const SizedBox(height: 16),
                    const Text(
                      'Project:',
                    ...
                    Text(
                      'Start Date: ${state.report!.project?.dates?.startDate ?? 'N/A'}',
                    ),
                    Text(
                      'End Date: ${state.report!.project?.dates?.endDate ?? 'N/A'}',
                    ),
                    if (state.report!.project?.subClient != null) ...[
                      Text(
                        'Sub Client: ${state.report!.project!.subClient!.name}',
                      ),
                    ],
                    const SizedBox(height: 16),
                    const Text(
